    ...
    <div class="site-info" theme-info="Sakurairo v<?php echo esc_html(IRO_VERSION); ?>">
      ...
      <div class="theme-info">
          <?php if (iro_opt('footer_sakura', 'true')): ?>
            <span class="sakura-icon">
              <svg width="16px" height="16px" t="1682340134496" class="sakura-svg" viewBox="0 0 1049 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5240">
